...
function out=slice(dat,N,n,dir)
  ...
  if dir==3
    dat=reshape(dat,N(1)*N(2),N(3)); %# Group into matrix with dir=3 as
				# cols
    out=reshape(dat(:,n),N(1),N(2)); %# Take n-th col and reshape as
				# slice
  elseif dir==2 
  ...
  elseif dir==1
    ...
    printf("\nError in slice(): invalid choice for dir. \
	dir=%f\n\n",dir);
  endif
